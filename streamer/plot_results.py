...
# SCHEMES = ['sim_rl', 'sim_bb', 'sim_mpc', 'sim_grad']
...
def main():
    ...
    log_files.remove("update_log")
    log_files.remove("playback_quality")
    # import pdb; pdb.set_trace()
    # log_files = [x if ".log" in file_name for file_name in log_files]
    # import pdb; pdb.set_trace()
    # import pdb; pdb.set_trace()
    # import pdb; pdb.set_trace()
    # log_files1 = []
